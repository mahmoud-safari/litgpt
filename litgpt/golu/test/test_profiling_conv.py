...
for dtype in datatypes:
    ...
    for activation_name in activations:
        ...
        model = TwoLayerCNN(in_channels, hidden_channels, out_channels, activation_name).to(device).to(dtype)
        model.train()
...
csv_filename = './litgpt/golu/test/activation_profiling_results_conv.csv'
